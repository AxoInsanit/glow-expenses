...
angular.module('Expenses', [])
    ...
    .constant('editExpensesUrlMockWebMocky', 'http://127.0.0.1:8080/service/EditExpense')
    .constant('editExpensesUrlMockEmulateWebMocky', '10.0.3.2:8080/service/EditExpense');
