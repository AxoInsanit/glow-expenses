...
angular.module('Directives').directive('editExpense', ['editExpenseTemplateUrl', function(editExpenseTemplateUrl) {
    return {
        restrict: 'E',
        controller: ['$scope', '$location', 'editExpensesTitle', 'editExpensesButtonLabel', 'expenseSharingSvc',
            ...
            function ($scope,  $location, editExpensesTitle, editExpensesButtonLabel, expenseSharingSvc, cameraSvc,
                ...
                debugger;
                $scope.expense = expenseSharingSvc.getExpenseById(expenseId, reportId);
...
//                    });
        ...
        templateUrl: editExpenseTemplateUrl
    };
}
]);